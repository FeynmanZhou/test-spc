...
const Features = () => {
  const featuresList = [
    ...
    },
    {
      ...
      desc: "HiTalker uses AI to create personalized emails for each recipient based on their past interactions with the brand.",
    },
    {
      icon: (
        <svg
      ...
      <div id="features" className="custom-screen text-gray-600">
        ...
        >
          <div className="max-w-xl mx-auto text-center">
            <h2 className="text-gray-00 text-3xl font-semibold sm:text-4xl">
              Start growing your email marketing with HiTalker
            </h2>
            <p className="mt-3">
              HiTalker makes it easy for you to create beautiful emails that get noticed and opened,
              track results, and build relationships with your customers.
            </p>
          </div>
        </LayoutEffect>
        <LayoutEffect
