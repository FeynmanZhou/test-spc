...
const faqsList = [
  ...
  {
    q: "Can I sell my digital products using HiTalker?",
    a: "Of course you can market and sell your digital products and subscriptions with HiTalker to drive higher conversions and save big on fees.",
  },
];
  ...
  <SectionWrapper id="faqs">
    <div className="custom-screen text-gray-600">
      <div className="max-w-xl text-center xl:mx-auto">
        ...
        <p className="mt-3">Here are the most questions people always ask about.</p>
      </div>
      <div className="mt-12">
        <LayoutEffect
          ...
          <ul className="space-y-8 gap-12 grid-cols-2 sm:grid sm:space-y-0 lg:grid-cols-3">
            {faqsList.map((item, idx) => (
              <li key={idx} className="space-y-3">
                ...
                <p dangerouslySetInnerHTML={{ __html: item.a }} className="leading-relaxed"></p>
              </li>
            ))}
          </ul>
        </LayoutEffect>
