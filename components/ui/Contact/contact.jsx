...
const Contact = () => {
  ...
  return (
    <div className="py-0"> {/* 移除上下边距 */}
      <div
        id="contact"
        className="bg-gradient-to-r from-[#6372ff] to-[#5ca9fb] text-gray-800"
      >
              ...
              <div className="text-center">
                <button
                  ...
                  className={`px-8 py-3 rounded-lg bg-white text-blue-600 font-semibold transform transition duration-200
                    ${loading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-opacity-90 hover:scale-105'}`}
                >
                  {loading ? (
